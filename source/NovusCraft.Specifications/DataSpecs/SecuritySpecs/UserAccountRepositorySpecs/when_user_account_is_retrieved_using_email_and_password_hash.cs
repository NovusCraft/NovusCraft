...
namespace NovusCraft.Specifications.DataSpecs.SecuritySpecs.UserAccountRepositorySpecs
{
	...
	public class when_user_account_is_retrieved_using_email_and_password_hash : user_account_repository_spec
	{
		static UserAccount user_account;
		Because of = () => user_account = repository.GetUserAccountByEmailAndPasswordHash(email: "example@company.com", passwordHash: "hash");
